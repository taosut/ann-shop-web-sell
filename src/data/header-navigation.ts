...
export const navigation: NavigationLink[] = [
    {label: 'Quần áo nam giá sỉ', url:'/shop', menu: {
        type: 'menu',
        items: [
            {label: 'Set bộ nam', url: '/shop/set-bo-nam'},
            {label: 'Áo thung nam', url: '/shop/ao-thung-nam', items: [
                {label: 'Áo thun cá sấu',    url: '/shop/ao-thung-ca-sau'},
                {label: 'Áo thun sọc ngang', url: '/shop/ao-thung-soc-ngang'},
                {label: 'Áo thun thể thao',  url: '/shop/ao-thung-the-thao'}
            ]},
        ] 
    }},
    // {label: 'Home', url: '/', menu: {
